...
export default class RadarSolidScanLayer {
	constructor(val) {
		this.entity = null;
		this.viewer = val.viewer;
		this.id = val.id || Util.generateUUID();
		...
		this.heading = 0;
		this.positionArr = this._calcPoints(
			val.position[0],
			val.position[1],
			val.shortwaveRange,
			0
	...
	addEntities() {
		this.entity = this.viewer.entities.add({
			...
			wall: {
				...
				material: new Cesium.Color.fromCssColorString("#ffffff82"),
			...
			ellipsoid: {
				...
				material: new Cesium.Color.fromCssColorString("#22ffffc7"), //颜色设置
				outline: true,
